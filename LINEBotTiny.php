...
class LINEBotTiny
{
    ...
    public function getLineDisplayNameByGroupID($UserID,$GroupId)
    {
        $header = array(
        ...
        if (strpos($http_response_header[0], '200') === false) {
            error_log('Request ' . $url . 'failed: ' . $response);
        }
		return $response ;
    }

	public function getLineDisplayName($UserID)
    {
        $header = array(
            'Content-Type: application/json',
            'Authorization: Bearer ' . $this->channelAccessToken,
	...
	public function replyFlexMessage($message)
    {
        $header = array(
            'Content-Type: application/json',
            'Authorization: Bearer ' . $this->channelAccessToken,
